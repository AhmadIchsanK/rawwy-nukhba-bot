...
async def update_user_menu(user_id: int, username: str, pool, bot):
    ...
    # 1. Base Menu (Identical to default)
    base_cmds = [
    ...
    if is_adm:
        base_cmds.extend([
            ...
            BotCommand("setbdaychannel", "[Admin] Set Group"),
            ...
            BotCommand("grouptasks", "[Admin] View Tasks"),
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Always attempt to sync groups and inject the menu
